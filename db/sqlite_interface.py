...
class SqliteInterface:
    ...
    @classmethod
    # 添加规则
    def add_rule(cls, uuid, enable, type, priority, date_list, time_list, src_dev_list, dst_dev_list, script_path,
                 py_path) -> bool:
        return cls.__sql.add_rule(uuid, enable, type, priority, date_list, time_list, src_dev_list, dst_dev_list,
                                  script_path, py_path)
    ...
    @classmethod
    def add_run_cmd(cls, dev_id, cmd_list):
        cls.__sql.add_run_cmd_tbl(dev_id=dev_id, cmd_list=cmd_list)

    @classmethod
    def get_run_cmd(cls):
        return cls.__sql.get_all_device_run_cmd()

    @classmethod
    def del_run_cmd_record(cls, dev_id):
        cls.__sql.del_run_cmd_record(dev_id=dev_id)
